...
def split_data(ratings, num_items_per_user, num_users_per_item,
    ...
    print("valid ratings shape ", valid_ratings.shape)
    ...
    for user in set(nz_users):
        ...
        # add to train set
        train[residual, user] = valid_ratings[residual, user].T

        # add to test set
        test[selects, user] = valid_ratings[selects, user].T
...
#1) Initialize matrix factorization
